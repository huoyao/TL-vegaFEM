...
#include <stdio.h>
#include "CGSolver.h"
//#define DEBUG_CGSOLVER_H

#ifdef DEBUG_CGSOLVER_H
...
#ifdef DEBUG_CGSOLVER_H
  printH(r, numRows, "./output/cg solver/cg_r_before_loop.txt");
  printH(d, numRows, "./output/cg solver/cg_d_before_loop.txt");
  printH(invDiagonal, numRows, "./output/cg solver/cg_invDiagonal_before_loop.txt");
#endif
