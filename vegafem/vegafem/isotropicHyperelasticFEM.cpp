...
//#define DEBUG_SVD_BINARY
//#define DEBUG_SVD_OUT
//#define DEBUG_GETFORCE
//#define DEBUG_TANGMATRIX
extern int g_rr;
...
#ifdef DEBUG_SVD_BINARY
  std::string dre = "./output/svd/";
  printH33<Mat3d>(Fs, endEl, dre+"fs_after.dat",std::ios_base::binary);
  printH33<Mat3d>(Us, endEl, dre + "us_after.dat", std::ios_base::binary);
  printH33<Mat3d>(Vs, endEl, dre + "vs_after.dat", std::ios_base::binary);
  printH3<Vec3d>(Fhats, endEl, dre + "fhats_after.dat", std::ios_base::binary);
#endif
#ifdef DEBUG_SVD_OUT
  std::string dre_ = "./output/svd/";
  printH33<Mat3d>(Fs, endEl, dre_+"fs_after.txt");
  printH33<Mat3d>(Us, endEl, dre_ + "us_after.txt");
  printH33<Mat3d>(Vs, endEl, dre_ + "vs_after.txt");
  printH3<Vec3d>(Fhats, endEl, dre_ + "fhats_after.txt");
#endif
#ifdef DEBUG_GETFORCE
  std::string dre = "./output/getforce/";
  printH<double>(internalForces, g_rr, dre + "force_after.txt");
#endif
#ifdef DEBUG_TANGMATRIX
  std::string dre_tan = "./output/getmat/";
  tangentStiffnessMatrix->output2file(dre_tan+"tangmat.txt",false);
#endif
  return exitCode;
}
